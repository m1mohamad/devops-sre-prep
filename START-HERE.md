...
Open this repository's root as your Obsidian vault, then use these entry points:

- [Interview Dashboard](docs/study/00-interview-dashboard.md)
- [Platform / DevOps / SRE Mental Models](docs/study/04-platform-devops-sre-mental-models.md)
...
- [Golden Path: From Idea to Production](docs/study/05-golden-path-from-idea-to-production.md)
...
- [Interview Companion](docs/interview/index.md)
- [Architecture Library](docs/architecture/index.md)
- [Production Simulator](docs/simulator/index.md)
- [Engineering Journey](docs/journey/index.md)

> Start with the Core Path when the full repository feels too broad.
