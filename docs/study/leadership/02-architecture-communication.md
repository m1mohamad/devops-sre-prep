...
aliases: [Architecture Communication]
---
...
An ADR records context, decision, alternatives, consequences and revisit triggers; diagrams communicate boundaries and flows to distinct audiences.

## Mental Model

Treat the observable boundary as part of the design. Separate facts, assumptions and decisions. Quantify migration stages, compatibility window, rollback and the evidence that permits progression.

## Architecture Diagram

```mermaid
flowchart LR
  Problem --> Options --> ADR --> Migration --> Review
```
...
An ADR records context, decision, alternatives, consequences and revisit triggers; diagrams communicate boundaries and flows to distinct audiences. Separate facts, assumptions and decisions. Quantify migration stages, compatibility window, rollback and the evidence that permits progression.
...
```bash
Validate the proposal with security, finance, operations and consuming teams before irreversible commitments.
```
...
Separate facts, assumptions and decisions. Quantify migration stages, compatibility window, rollback and the evidence that permits progression.
...
Describe one production decision involving **Architecture Communication**: quantify impact, show the evidence that changed your mind, and name the durable guardrail.
